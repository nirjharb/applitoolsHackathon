...
public class TraditionalTestsV1 {
	...
	@Test
	@Parameters("browser")
	public void TraditionalTestsV1(String browserName) throws InterruptedException, Exception
	{
		if(browserName.equalsIgnoreCase("firefox"))
		{
			...
			System.out.println(driver.findElement(By.xpath("//*[@id=\"OPTION____199\"]")).getText() + "   "
			...
			// Script for finding Add to Favorites button on Mousehover for firefox for V1
			...
			driver.findElement(By.xpath("//*[@id=\"IMG__imgfluid__308\"]")).click();
			TakesScreenshot ts = (TakesScreenshot)driver;
			File source=ts.getScreenshotAs(OutputType.FILE);
			FileHandler.copy(source, new File("./Screenshot/firefox.jpg"));
			...
			FileHandler.copy(src, new File("./Screenshot/firefoxfilteroutput.jpg"));
		...
		else if(browserName.equalsIgnoreCase("chrome"))
		{
			...
			// Script for product details validation.
			driver.findElement(By.xpath("//*[@id=\"IMG__imgfluid__264\"]")).click();
			TakesScreenshot ts = (TakesScreenshot)driver;
			File source=ts.getScreenshotAs(OutputType.FILE);
			FileHandler.copy(source, new File("./Screenshot/chrome.jpg"));
			...
			TakesScreenshot tsc = (TakesScreenshot)driver;
			File src=tsc.getScreenshotAs(OutputType.FILE);
			FileHandler.copy(src, new File("./Screenshot/chromefilteroutput.jpg"));
		}
		else if(browserName.equalsIgnoreCase("edge"))
		{
			...
			// Script for product details validation.
			driver.findElement(By.xpath("//*[@id=\"IMG__imgfluid__399\"]")).click();
			TakesScreenshot ts = (TakesScreenshot)driver;
			File source=ts.getScreenshotAs(OutputType.FILE);
			FileHandler.copy(source, new File("./Screenshot/edge.jpg"));
			...
			TakesScreenshot tsc = (TakesScreenshot)driver;
			File src=tsc.getScreenshotAs(OutputType.FILE);
			FileHandler.copy(src, new File("./Screenshot/edgefilteroutput.jpg"));
		}
		else if(browserName.equalsIgnoreCase("tablet"))
		{
			...
			// Script for finding Add to Favorites button on Mousehover for Tablet for V1
			...
			// Script for product details validation.
			driver.findElement(By.xpath("//*[@id=\"IMG__imgfluid__215\"]")).click();
			TakesScreenshot ts = (TakesScreenshot)driver;
			File source=ts.getScreenshotAs(OutputType.FILE);
			FileHandler.copy(source, new File("./Screenshot/tablet.jpg"));
			...
			TakesScreenshot tsc = (TakesScreenshot)driver;
			File src=tsc.getScreenshotAs(OutputType.FILE);
			FileHandler.copy(src, new File("./Screenshot/tabletfilteroutput.jpg"));
		...
		else if(browserName.equalsIgnoreCase("mobile"))
		{
			...
			// Script for finding Add to Favorites button for Mobile for V1
			...
			// Script for Search bar in mobile in V1
			Thread.sleep(2000);
			driver.findElement(By.xpath("//*[@id=\"A__btnsearchm__59\"]")).click();
			driver.findElement(By.xpath("//*[@id=\"INPUTtext__formcontro__62\"]")).sendKeys("Appli Ait x Night");
			driver.findElement(By.xpath("//*[@id=\"INPUTsubmit__btnfullwid__63\"]")).click();
			...
			// Script for product details validation.
			driver.findElement(By.xpath("//*[@id=\"IMG__imgfluid__240\"]")).click();
			TakesScreenshot ts = (TakesScreenshot)driver;
			File source=ts.getScreenshotAs(OutputType.FILE);
			FileHandler.copy(source, new File("./Screenshot/mobile.jpg"));
			...
			TakesScreenshot tsc = (TakesScreenshot)driver;
			File src=tsc.getScreenshotAs(OutputType.FILE);
			FileHandler.copy(src, new File("./Screenshot/mobilefilteroutput.jpg"));
